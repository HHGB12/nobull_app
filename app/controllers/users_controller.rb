class UsersController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:business_name, :direct_phone_number, :has_current_website, :current_website, :business_details_complete, :integrations_complete, :services_contents_complete, :is_submitted)
    end
end
